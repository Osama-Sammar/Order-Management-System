...
//import org.example.payload.OrderDto;
...
//    @ApiOperation(value = "Get orders for a specific customer")
...
//    public ResponseEntity<OrderDto> createOrder(@PathVariable Integer customerId, @RequestBody OrderDto orderDto) {
